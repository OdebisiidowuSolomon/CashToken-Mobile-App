    ...
    <ScrollView style={styles.screen}>
      <View>
        ...
        <View
          ...
          <View
            ...
            <View style={{flexDirection: 'row'}}>
              <Text style={{marginRight: 30, color: COLORS.black}}>
                Tina Anya
              </Text>
        ...
        <ProfileListItem
          ...
          title={'History'}
          subtitle={'See all my transaction'}
        />
        <ProfileListItem
          navigate={navigate}
          path={'ReferralIndex'}
          title={'Refer and Earn'}
          subtitle={'Invite your friends to join CashToken'}
        />
...
const ProfileListItem = ({navigate, path, title, subtitle}) => {
  return (
    <TouchableOpacity
